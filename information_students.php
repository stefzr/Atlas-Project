...
<head>
    <meta charset="utf-8">
    <title>ΑΤΛΑΣ - Πληροφόρηση Φοιτητή</title>
        ...
        <ul class="steps-list">
            <div class="row">
                <li class="step">
                    ...
                    <header>
                        <h6>
                        <a href="search-internship.php">Αναζήτηση Θέσεων</a> Πρακτικής Άσκησης
                        </h6>
                    </header>
                    <span>Φοιτητές/τριες αναζητούν θέσεις πρακτικής άσκησης με βάση κριτηρίων όπως τοποθεσία, ημερομηνία έναρξης, διάρκεια απασχόλησης, τρόπος απασχόλησης και Τμήμα που αφορούν.</span>
                </li>
                <li class="step">
                    <header>
                        <h4>
                    ...
                    <header>
                        <h6>
                            Προβολή Θέσης Πρακτικής Άσκησης
                        </h6>
                    </header>
                    <span>Στην συνέχεια, οι φοιτητές/τριες επιλέγοντας κάποια θέση πρακτικής άσκησης από τα αποτελέσματα αναζήτησης μπορούν να δουν την αμοιβή της καθώς και επιπλέον πληροφορίες για αυτή στο κείμενο περιγραφής. Παρέχονται επίσης τα στοιχεία επικοινωνίας του Φορέα.</span>
                </li>
                <li class="step">
                    <header>
                        <h4>
                            Βήμα 3 (Προϋποθέτει <a href="login.php">Σύνδεση</a>)
                        </h4>
                    </header>
                    <header>
                        <h6>
                            Υποβολή Αίτησης για θέση Πρακτικής Άσκησης
                        </h6>
                    </header>
                    <span>Στο τελικό βήμα οι φοιτητές/τριες υποβάλουν την αίτηση τους για κάθε θέση Πρακτικής Άσκησης που τους ενδιαφέρει. Αυτές μπορούν να είναι περισσότερες από μία και να αποθηκευτούν προσωρινά. Για να υποβάλουν αίτηση τους πρέπει να εισάγουν την αναλυτική τους βαθμολογία (σε μορφή αρχείου pdf) και μια παράγραφο που να περιγράφουν γιατί ενδιαφέρονται για την θέση αυτή. Έπειτα η αίτηση γίνεται εκκρεμής και υπάρχει δυνατότητα διαγραφής της από τον αιτών/ούσα.</span>
                </li>
            </div>
        </ul>
    </section>
