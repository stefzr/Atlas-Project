...
<head>
    <meta charset="utf-8">
    <title>ΑΤΛΑΣ - Στοιχεία Λογαριασμού Φοιτητή/τριας</title>
...
<body class="d-flex flex-column" style="min-height: 100vh;">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Στοιχεία Φοιτητή/τριας</a>
        </li>
        <li class="nav-item">
    ...
    <form class="bg-white" style="display: flex; flex-direction: column; margin: 1rem auto; min-width: 25%;" action=" " method="post" autocomplete="off">
        <div class="form-item" style="margin: 0rem;">
            <header>
                <h5> Στοιχεία Φοιτητή/τριας </h5>
            </header>
            ...
            <div class="form-group">
                <label for="first-name">Επίθετο</label>
                <div class="row">
                    <div class="col">
                        <input type="text" class="form-control bg-white" id="first-name" name="first-name" disabled readonly value="<?= $user['last_name']; ?>">
                    </div>
                </div>
            </div>

            <div class="form-group">
                <label for="university-name">Ακαδημαϊκό Ίδρυμα</label>
                <input type="text" class="form-control bg-white" id="university-name" name="university-name" disabled readonly value="<?= $user['university_name']; ?>">
            </div>

            <div class="form-group">
                <label for="university-department-name">Τμήμα</label>
                <input type="text" class="form-control bg-white" id="university-department-name" name="university-department-name" disabled readonly value="<?= $user['university_department']; ?>">
            </div>

            <div class="form-group">
                <label for="student-id">Αριθμός Μητρώου</label>
                <input type="text" class="form-control bg-white" id="student-id" name="student-id" disabled readonly value="<?= $user['student_id']; ?>">
            </div>
        </div>
        <!-- <button type="submit" class="btn btn-primary" style="align-self: center;">Επεξεργασία Στοιχείων Ονοματεπώνυμου</button> -->
    </form>
